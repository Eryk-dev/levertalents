...
- [x] **RS-04
**: Mover candidato valida transição via `canTransition()` antes de chamar `mutate` (corrige rejeições servidor-side silenciosas)
- [x] **RS-05
...
- [x] **RS-08
**: Card do candidato no kanban mostra sparkbar de distribuição por stage e indicador de SLA (verde/amarelo/vermelho conforme tempo no stage)
...
Mapping REQ-IDs → ROADMAP.md phases. Generated by gsd-roadmapper on 2026-04-27.
...
| RBAC-07 | Phase 1 | Pending |
| RBAC-08 | Phase 1 | Pending |
| RBAC-09 | Phase 1 | Pending |
| RBAC-10 | Phase 1 | Pending |
...
| RS-04 | Phase 2 | Done (Plan 02-03) |
| RS-05 | Phase 2 | Done (Plan 02-02 SQL + Plan 02-04 push to remote) |
| RS-06 | Phase 2 | Done (Plan 02-02 SQL + Plan 02-04 push to remote) |
| RS-07 | Phase 2 | Pending |
| RS-08 | Phase 2 | Done (Plan 02-03) |
| RS-09 | Phase 2 | Pending |
| RS-10 | Phase 2 | Pending |
| RS-11 | Phase 2 | Pending |
| RS-12 | Phase 2 | Pending |
| TAL-01 | Phase 2 | Pending |
| TAL-02 | Phase 2 | Pending |
| TAL-03 | Phase 2 | Done (Plan 02-02 SQL + Plan 02-04 push to remote) |
| TAL-04 | Phase 2 | Pending |
| TAL-05 | Phase 2 | Done (Plan 02-02 SQL + Plan 02-04 push to remote) |
| TAL-06 | Phase 2 | Done (Plan 02-02 SQL + Plan 02-04 push to remote) |
| TAL-07 | Phase 2 | Pending |
| TAL-08 | Phase 2 | Pending |
| TAL-09 | Phase 2 | Done (Plan 02-02 SQL + Plan 02-03 client mirror + Plan 02-04 push to remote) |
...
**Coverage check:** 82/82 v1 requirements mapped (100%). No orphans, no duplicates.

**Phase distribution:**
- Phase 1 (Tenancy Backbone): 36 requirements
- Phase 2 (R&S Refactor): 21 requirements
- Phase 3 (Performance Refactor): 16 requirements
- Phase 4 (Dashboards + Quality Polish): 10 requirements (less code, more polish/tests/migration G)

---

*Total v1: 82 requirements | v2 deferred: 7 | Out of scope: 14 anti-features*
